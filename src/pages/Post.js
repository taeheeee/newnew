...
const Post = () => {
  ...
  // useEffect(() => {
  //   (async () => {
  //     const posts = await axios.get("http://146.56.187.171/api/posts");
  ...
  return (
    <React.Fragment>
      {/* {postList.map((x, y) => console.log(x))} */}
...
<Grid is_flex padding="16px">
  <Grid is_flex width="auto">
    <Image
      shape="circle"
      src="https://www.allkpop.com/upload/2021/12/content/231225/web_data/allkpop_1640280755_untitled-1.jpg"
    />
    <Text bold>기본 이름</Text>
  </Grid>
  <Grid is_flex width="auto">
